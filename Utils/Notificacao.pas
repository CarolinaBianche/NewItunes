  ...
  TMensagem = class
    ...
    public
          ...
          class procedure ToastMessage(const Frm : Tform; const msg: string;
                                      ...
                                      cor_fundo: Cardinal = $FFCC1616;//$FF22AF70;
...
class procedure TMensagem.Hide;
begin
...
class procedure TMensagem.Show(const Frm : Tform; const msg: string);
var
...
class procedure TMensagem.DeleteToast(Sender: TObject);
begin
...
class procedure TMensagem.ToastMessage(const Frm : Tform; const msg: string;
                                      alinhamento: TAlignLayout = TAlignLayout.Bottom;
                                      cor_fundo: Cardinal = $FFCC1616;//$FF22AF70;
                                      cor_fonte: Cardinal = $FFFFFFFF;
                                      duracao: integer = 4);
...
begin
        ...
        FundoToast.Margins.Bottom := 50;
        FundoToast.Margins.Top := 200;
        ...
        AnimacaoToast.OnFinish := TMensagem.DeleteToast;
